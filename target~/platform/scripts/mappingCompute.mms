...
# REST
substract $Label_REST $Label_REST $Computed
union $Computed $Computed $Label_REST

# Observable
substract $Label_Observable $Label_Observable $Computed
union $Computed $Computed $Label_Observable

# Trace
substract $Label_Trace $Label_Trace $Computed
union $Computed $Computed $Label_Trace
...
# ECOM COMM
substract $Label_ECOMCOMM $Label_ECOMCOMM $Computed
union $Computed $Computed $Label_ECOMCOMM
...
# Wadapps
substract $Wadapps $Wadapps $Computed
union $Computed $Computed $Wadapps
...
substract LibAddonEclasspath_SET LibAddonEclasspath_SET $Computed
union $Computed $Computed LibAddonEclasspath_SET
...
# ECOM COMM Stack
substract $Label_NativeStackECOMCOMM $Label_NativeStackECOMCOMM $Computed
union $Computed $Computed $Label_NativeStackECOMCOMM
...
# MicroUI Stack
substract $Label_NativeStackMicroUI $Label_NativeStackMicroUI $Computed
union $Computed $Computed $Label_NativeStackMicroUI
